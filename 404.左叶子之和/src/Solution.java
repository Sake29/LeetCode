...
public class Solution {
    ...
    public void test(){
        ...
        int sumOfLeft1 = sumOfLeftLeaves(tree1);
        System.out.println("左叶子节点和："+sumOfLeft1);*/

        Integer[] nodes2 = {1,2,3,4,5};
        TreeNode tree2 = Utills.createTree(nodes2);
        Utills.printTree(tree2);
        int sumOfLeft2 = sumOfLeftLeaves(tree2);
        System.out.println("左叶子节点和："+sumOfLeft2);
    }
}
