...
public class Solution {
     ...
     * 两节点的最长路径
     * 每次递归都到离根节点最远的结点A
     * 本题和求树深度很像，唯一区别就是每次递归都要判断当前结点离
     * 结点A的距离是否为最大。如果大于最大，则更新最大。
     * @param root
     * @return
     */
    ...
    public int depth(TreeNode root){
        ...
        //一直到该节点没有子节点时，停止递归
        //该节点为根节点时，求以他左儿子为根节点的子树的深度
        int leftLength = depth(root.left);
        //一直到该节点没有子节点时，停止递归
        //该节点为根节点时，求以他右儿子为根节点的子树的深度
        int rightLength = depth(root.right);
        //比较max是否大于左子树深度+右子树深度，即左子树的根节点到右子树的根节点的距离
    ...
    @Test
    public void test(){
        Integer[] nodes = {1,2,3,4,5,6,7,8,9,null,11};
